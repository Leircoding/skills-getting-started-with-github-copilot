          ...
          btn.addEventListener('click', async (e) => {
            ...
            try {
              ...
              if (response.ok) {
                ...
                // Optionally update spots left
                const spotsElem = activityCard.querySelector('p strong + text, p strong + span');
                // If you want to update spots left, you can re-fetch or recalculate here
              } else {
